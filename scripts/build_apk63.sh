#!/bin/bash
# Сборка PLENKA-native-3.16.apk (v63) командной строкой: aapt2 + kotlinc + d8 + apksigner.
...
OUT=/home/z/my-project/download/PLENKA-native-3.16.apk
...
"$BT/aapt2" link -o "$W/base.apk" -I "$AJ" \
  ...
  --version-code 145 --version-name 3.16 \
