#!/bin/bash
# Сборка PLENKA-native-3.14.apk (v61) командной строкой: aapt2 + kotlinc + d8 + apksigner.
...
OUT=/home/z/my-project/download/PLENKA-native-3.14.apk
...
"$BT/aapt2" link -o "$W/base.apk" -I "$AJ" \
  ...
  --version-code 143 --version-name 3.14 \
