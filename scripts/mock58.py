...
HTML = os.path.join(ROOT, 'download', 'plenka-optimized-58.html')
...
BRIDGE = r"""
<script>
/* MOCK PlenkaNative 3.12 — строгая арность; журнал mediaState/setPipAuto;
...
(function(){
  ...
  window.PlenkaNative={
    ...
    version:arity0('version',function(){return 'PLENKA native 3.12 (v58, MOCK)'}),
...
if __name__ == '__main__':
    with TS(('127.0.0.1', PORT), H) as httpd:
        print('mock 3.12 on http://127.0.0.1:%d/ (v58)' % PORT, flush=True)
        httpd.serve_forever()
