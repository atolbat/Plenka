#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Мок сервера ПЛЁНКА 3.16 (v63): / → v62, /seek → стенд v51, /lab → лаба v51,
...
HTML = os.path.join(ROOT, 'download', 'plenka-optimized-63.html')
...
(function(){
  ...
  window.PlenkaNative={
    ...
    version:arity0('version',function(){return 'PLENKA native 3.16 (v62, MOCK)'}),
...
if __name__ == '__main__':
    with TS(('127.0.0.1', PORT), H) as httpd:
        print('mock 3.16 on http://127.0.0.1:%d/ (v63)' % PORT, flush=True)
        httpd.serve_forever()
