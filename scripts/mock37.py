#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Мок нативного сервера ПЛЁНКА 2.2 для смоук-теста v37 в headless-браузере.

Режимы (arg1): full (по умолчанию — мост жив, скан с файлами),
                empty (мост жив, скан ок но 0 items + skipN — «все файлы mkv/ts»),
                nobridge (мост НЕ инжектируется — плашка «мост мёртв» + ДИАГ).
"""
import os, re, json, sys, socketserver
from http.server import BaseHTTPRequestHandler, ThreadingHTTPServer
from urllib.parse import urlparse

BASE = os.path.dirname(os.path.abspath(__file__))
MEDIA = os.path.join(BASE, "nativemedia")
HTML = "/home/z/my-project/download/plenka-optimized-37.html"
PORT = 8977
...
MOCK_BRIDGE = """
<script>
/* MOCK PlenkaNative — сигнатуры Kotlin-моста 2.2 */
(function(){
  var SCAN=%SCAN%;
  var PICKED=%PICKED%;
  var reported=[];
  ...
  window.PlenkaNative={
    ...
    version:function(){ return 'PLENKA native 2.2 (v37, MOCK)' }
  };
})();
</script>
"""
...
if __name__ == "__main__":
    ...
    print(f"mock server 2.2 on http://127.0.0.1:{PORT}/")
