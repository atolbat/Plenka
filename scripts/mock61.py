#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Мок сервера ПЛЁНКА 3.13 (v61): / → v61, /seek → стенд v51, /lab → лаба v51,
...
HTML = os.path.join(ROOT, 'download', 'plenka-optimized-61.html')
...
(function(){
  ...
  window.PlenkaNative={
    ...
    version:arity0('version',function(){return 'PLENKA native 3.13 (v61, MOCK)'}),
...
if __name__ == '__main__':
    with TS(('127.0.0.1', PORT), H) as httpd:
        print('mock 3.13 on http://127.0.0.1:%d/ (v61)' % PORT, flush=True)
        httpd.serve_forever()
